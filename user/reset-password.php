                        ...
                        <div class="row">
                            <div class="ops-md-5 mx-auto box-shadow">
                                ...
                                <form method="POST" action="forgot-pass.php">
                                    <div class="ops-form-group row">
                                        <label for="inputEmail3" class="ops-sm-2 col-form-label">Email</label>
                                        <div class="ops-sm-10">
                                            <input type="email" name="email" class="form-control" id="inputEmail3" placeholder="Email">
                                        </div>
                                    </div>
                                    ...
                                    <div class="ops-form-group row">
                                        <div class="offset-sm-2 ops-sm-10">
                                            <button type="submit" name="submit" style="background: green" class="btn btn-info">Send Email and reset</button>
                                        </div>
                                    </div>
                                </form>
