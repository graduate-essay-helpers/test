<div class="ops-form-group row">
    <label for="exampleSelect1" class="ops-sm-4 col-form-label">Time Zone</label>
    <div class="ops-sm-8">
        <select name="client_timezone" class="form-control custom-select border-default" id="exampleSelect1">
            <option value=""></option>
