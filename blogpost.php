...
$qry = mysqli_query($con, "SELECT * FROM blog WHERE id='" . $id . "'");
...
<head>
    ...
    <title>Blog | <?php echo $fetch['title'] ?></title>
    <script>
                                            ...
                                            <div class="wpb_column vc_column_container vc_col-sm-8">
                                                <div class="vc_column-inner vc_custom_1527765435779">
                                                    <div class="wpb_wrapper">
                                                        <!-- <h6 style="font-size: 15px;color: #0c121f;line-height: 26px;text-align: left" class="vc_custom_heading font-weight-medium letter-spacing-1 vc_custom_1580476666967"> -->
                                                        <div style="font-size: 15px;color: #0c121f;line-height: 26px;text-align: left">
                                                            <ul class="breadcrumb">
                                                                <li><a href="./">Home</a></li>
                                                                <li><a href="blog.php">Blog</a></li>
                                                                <li class="ttl"><?php echo $fetch['title'] ?></li>
                                                            </ul>
                                                        </div>
                                                        <!-- </h6> -->
                                                        <h3 style="font-size: 30px;color: #0c121f;line-height: 40px;text-align: left" class="vc_custom_heading font-weight-bold vc_custom_1580476685758"><?php echo $fetch['title'] ?></h3>
