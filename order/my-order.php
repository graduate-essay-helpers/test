                        ...
                        <div class="orderlib">
                            ...
                            ?>
                                <div class="row">
                                    ...
                                    <div class="ops-sm-2">
                                        <a href="./order-checkout.php?id=<?php echo $fetch['id'] ?>"> <?php echo $fetch['title'] ?> </a>
                                    </div>
                                    <div class="ops-sm-2">
                                    ...
                                    ?>
                                        <div class="ops-sm-2">bidding || unpaid</div>
                                    <?php
                                    }
                                    ?>
                                    ...
                                    <div class="ops-sm-1 text-center"></div>
                                    <div class="ops-sm-2">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row text-center">
                                                                <div class="col">
                                                                    <h6> View payment details for your order</h6>
                                                                    <hr />
                                                                    <a class="btn ops-sm-12 btn-danger text-white" href="https://graduate-essay-helpers.com/order/choose-payment.php?id=<?php echo $fetch['id'] ?>">Payment </a>
                                                                </div>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row text-center">
                                                                <div class="col">
                                                                    ...
                                                                    <hr />
                                                                    <a class="btn ops-sm-12 btn-danger text-white" href="https://graduate-essay-helpers.com/order/choose-payment.php?id=<?php echo $fetch['id'] ?>">Pay ($<?php echo $fetch['total'] ?>) </a>
                                                                </div>
