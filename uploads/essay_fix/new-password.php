                ...
                <section class="download features" id="download">
                    <div class="row">
                        <div class="ops-md-5 mx-auto box-shadow">
                            ...
                            <div class="ops-md-12">
                                <form role="form" action="new-password.php" method="POST">




                                    <div class="ops-form-group row">
                                        <label for="inputEmail3" class="ops-sm-3 col-form-label text-muted">New password</label>
                                        <div class="ops-sm-9">
                                            <input type="password" name="password" class="form-control" placeholder="Create new password" required>
                                        </div>
                                    </div>
                                    <div class="ops-form-group row">
                                        <label for="inputEmail3" class="ops-sm-3 col-form-label text-muted">Confirm password</label>
                                        <div class="ops-sm-9">
                                    ...
                                    <div class="ops-form-group row">
                                        <div class="offset-sm-2 ops-sm-10">
                                            <button type="submit" class="form-control button btn btn-primary" name="change-password">Change</button>
                                        </div>
                                    </div>
                                </form>
