...
<head>
    ...
    <title>404 error | GraduateEssayHelpers</title>

    <link rel="stylesheet" href="https://graduate-essay-helpers.com/error/assets/style.css">
    <script src="https://graduate-essay-helpers.com/error/assets/func.js"></script>
    
    <link rel="icon" href="./image/grad_books.png" sizes="32x32" />

    <link rel="icon" href="./image/grad_books.png" sizes="192x192">

    <link rel="apple-touch-icon-precomposed" href="./image/grad_books.png" />

    <meta name="msapplication-TileImage" content="./image/grad_books.png" />
...
<body class="permission_denied">
    ...
    <div class="denied__wrapper">
        <h1>404</h1>
        <h3>LOST IN <span>SPACE</span> GraduateHelpers? Hmm, looks like that page doesn't exist.</h3>
        ...
        <a href="https://graduate-essay-helpers.com"><button class="denied__link">Go Home</button></a>
    </div>
