...
<head>
    ...
    <title>Code Verification | GraduateEssayHelpers</title>
                            ...
                            <div class="ops-md-12">
                                <form action="reset-code.php" method="POST" autocomplete="off">
                                    ...
                                    <div class="ops-form-group row">
                                        ...
                                        <div class="ops-sm-9">
                                            <input type="number" name="otp" class="form-control" id="otp" placeholder="Enter verification code" required>
                                        </div>
                                    </div>
                                    <div class="ops-form-group row">
                                        <div class="offset-sm-2 ops-sm-10">
                                            <!-- <button type="submit" class="btn btn-primary" name="registerNewUser">Sign up</button> -->
                                            <input type="submit" class="form-control button btn btn-primary" name="check-reset-otp" value="Submit">
                                        </div>
                                    </div>
                                </form>
