                            ...
                            <div class="ops-md-12">
                                <form action="user-otp.php" method="POST" autocomplete="off">
                                    ...
                                    <div class="ops-form-group row">
                                        <label for="inputEmail3" class="ops-sm-3 col-form-label text-muted">Verification code</label>
                                        <div class="ops-sm-9">
                                    ...
                                    <div class="ops-form-group row">
                                        <div class="offset-sm-2 ops-sm-10">
                                            ...
                                            <input type="submit" class="form-control button btn btn-primary" name="check" value="Submit">
                                        </div>
                                    </div>
                                </form>
