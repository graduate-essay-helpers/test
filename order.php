...
<head>
    ...
    <title>Login/Register | GraduateWriters</title>
    ...
    <div class="radiantthemes-website-layout full-width">
        ...
        <div id="page" class="site">
            ...
            <div id="content" class="site-content">
                ...
                <link rel="stylesheet" type="text/css" href="order_assets/dropzone/basic.min.css">
                <script type="text/javascript" src="order_assets/dropzone/dropzone.min.js"></script>
                <script src="order_assets/dropzone/ckeditor.js"></script>
                <style>
                    .row {
